...
@Composable
fun EditModelSettingsScreen(
    viewModel: SmsListViewModel,
    onBackClicked: () -> Unit,
) {
    val currChat by viewModel.smsAnalysisChat.collectAsStateWithLifecycle()
    currChat.let { chat ->
        ...
        SmolLMAndroidTheme {
            Scaffold(
                topBar = {
                    TopAppBar(
                        title = { AppBarTitleText(stringResource(R.string.edit_model_settings_screen_title)) },
                        navigationIcon = {
                                ...
                                onClick = {
                                    ...
                                    if (chat != updatedChat) {
                                        ...
                                        Toast
                                            .makeText(
                                                context,
                                                context.getString(R.string.edit_model_new_settings_applied),
                                                Toast.LENGTH_LONG,
                                            ).show()
                                    }
                                    onBackClicked()
